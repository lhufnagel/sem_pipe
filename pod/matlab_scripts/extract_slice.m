...
[data,lr1,elmap,time,istep,fields,emode,wdsz,etag,header,status] = readnek('./pipe_c_mode0.f00003');
if status < 0 
...
writenek(['slab_mode0.f' num2str(m,'%05d')],data2d,lr1,elmap,z_val(m),m,fields,emode,wdsz,etag);
end
